...
namespace TeamDinnerOD
{
    public partial class Form2 : Form
    {
        ...
        private void btnVT_Click(object sender, EventArgs e)
        {
            ...
            vt.ShowDialog();  // 這會顯示 TeamVT 且阻止回到 Form1
        }
        ...
        {
            // 建構 SQL 查詢語句
            string query = @"SELECT bd.ID, bl.loguser, bd.CardNo, bd.DDate, bd.BeVisit, bd.Department, bd.Reason, bd.dbs
                             FROM BookDinner bd
